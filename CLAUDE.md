...
element. Don't improvise "reasonable-looking" defaults; check them against
that file. Read [BUILD_LOG.md](BUILD_LOG.md) at the start of any session to
see what phase the build is in and what's left.
